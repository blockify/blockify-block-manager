...
function rootCheck(options, config) {
    ...
    errorMsg = 'Since blockify is a user command, there is no need to execute it \
with superuser permissions.\nIf you\'re having permission errors when using blockify \
without sudo, please spend a few minutes learning more about how your system should \
